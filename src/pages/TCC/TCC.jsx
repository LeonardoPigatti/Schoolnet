...
const S = {
  ...
  btnSalvar: { padding: "12px", border: "none", borderRadius: 10, background: "#1c202b", border: "1px solid #252a38", color: "#e8eaf0", fontWeight: 700, fontSize: 14, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 },
  btnEnviar: { padding: "12px", border: "none", borderRadius: 10, background: "linear-gradient(135deg,#5b6cff,#a78bfa)", color: "#fff", fontWeight: 700, fontSize: 14, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 },
